...
#define WIFI_SSID "iPhone"  // Change to "iPhone" or your hotspot name
#define WIFI_PASSWORD "your_hotspot_password"  // Update with your hotspot password
...
void connectToFirebase() {
  ...
  config.timeout.serverResponse = 10000;    // 10 second timeout
  config.timeout.socketConnection = 10000;  // 10 second connection timeout
